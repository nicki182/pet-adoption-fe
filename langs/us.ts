...
export default {
  ...
  [Constants.PET_NAME]: 'Name',
  [Constants.PET_TYPE]: 'Type',
  [Constants.PET_BREED]: 'Breed',
  [Constants.PET_AGE]: 'Age',
  [Constants.PET_DESCRIPTION]: 'Description',
  [Constants.PET_IMAGE]: 'Image',
  [Constants.PET_DIETARY_DESCRIPTION]: 'Dietary Description',
};
